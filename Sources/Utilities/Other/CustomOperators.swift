...
public func +=<Bound: Numeric>(
    range: inout Range<Bound>, offset: Bound
) {
...
/// Offsets a range by a given amount.
public func +=<Bound: Numeric>(
    range: inout ClosedRange<Bound>, offset: Bound
) {
...
/// Offsets a range by a given amount.
public func +=<Bound: Numeric>(
    range: inout PartialRangeFrom<Bound>, offset: Bound
) {
...
/// Offsets a range by a given amount.
public func +=<Bound: Numeric>(
    range: inout PartialRangeThrough<Bound>, offset: Bound
) {
...
/// Offsets a range by a given amount.
public func +=<Bound: Numeric>(
    range: inout PartialRangeUpTo<Bound>, offset: Bound
) {
